...
class Protocol6AdministrativeScreen extends StatelessWidget {
  const Protocol6AdministrativeScreen({super.key});
    ...
    return const BaseScaffold(
        ...
        body: Stack(children: <Widget>[
          SingleChildScrollView(
            child: Column(
              children: <Widget>[
                TitleText(text: Protocol6AdministrativeSreenTexts.heading, addHorizontalPadding: true,),
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ListBulletPoints(
                          bulletPoints:
                              Protocol6AdministrativeSreenTexts.bulletPoints,
                          ),
                      SizedBox(height: 80),
                    ],
                  ),
          ...
          NextButton(
            title: Protocol6AdministrativeSreenTexts.buttonText,
